...
import torch
from vlex_ria.core.config import load_config, VLexRIAConfig
...
def test_dpo_training(max_steps: int = 10) -> Dict[str, Any]:
    ...
    from vlex_ria.data import create_rl_dataloaders
    from vlex_ria.training import DPOTrainer
    ...
    config.rl.tensorboard_dir = 'artifacts/runs/test_dpo'
    config.rl.checkpoint_dir = 'artifacts/checkpoints/test_dpo'
...
def test_grpo_training(max_steps: int = 5) -> Dict[str, Any]:
    ...
    from vlex_ria.data import create_rl_dataloaders
    from vlex_ria.training.rl_trainer_algorithms import GRPOTrainer
    from vlex_ria.training import RuleBasedReward
    ...
    config.rl.tensorboard_dir = 'artifacts/runs/test_grpo'
    config.rl.checkpoint_dir = 'artifacts/checkpoints/test_grpo'
...
def test_ppo_training(max_steps: int = 5) -> Dict[str, Any]:
    ...
    from vlex_ria.data import create_rl_dataloaders
    from vlex_ria.training.rl_trainer_algorithms import PPOTrainer
    from vlex_ria.training import RuleBasedReward
    ...
    config.rl.save_steps = max_steps + 1
    config.rl.max_new_tokens = 32
    config.rl.tensorboard_dir = 'artifacts/runs/test_ppo'
    config.rl.checkpoint_dir = 'artifacts/checkpoints/test_ppo'
...
def test_full_rl_pipeline() -> Dict[str, Any]:
    ...
    from vlex_ria.data import create_rl_dataloaders, create_dataloaders
    from vlex_ria.training import DPOTrainer, PretrainTrainer, SFTTrainer
    ...
    config.pretraining.tensorboard_dir = 'artifacts/runs/test_pipeline_pretrain'
    config.pretraining.checkpoint_dir = 'artifacts/checkpoints/test_pipeline_pretrain'
    ...
    config.sft.tensorboard_dir = 'artifacts/runs/test_pipeline_sft'
    config.sft.checkpoint_dir = 'artifacts/checkpoints/test_pipeline_sft'
    ...
    config.rl.tensorboard_dir = 'artifacts/runs/test_pipeline_dpo'
    config.rl.checkpoint_dir = 'artifacts/checkpoints/test_pipeline_dpo'
...
# Main
def main():
    parser = argparse.ArgumentParser(description="VLexRIA RL Test Suite")
    ...
    print_header("VLexRIA RL Test Suite")
