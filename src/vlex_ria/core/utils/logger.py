...
class VLexRIALogger:
    """
    Logger wrapper for VLexRIA project.
...
def get_logger(
    ...
    """
    return VLexRIALogger.get_logger(name, level, use_color, show_symbols)
...
def set_log_level(level: int):
    ...
    """
    VLexRIALogger.set_default_level(level)


def setup_file_logging(
    filepath: str = "logs/vlex_ria.log",
    level: Optional[int] = None
):
    """
